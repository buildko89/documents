<div class="box-title">
    ...
    <p>
    <div style="font-size:12pt;font-weight:bold;text-align:center;margin-top:100px"><span class="author">箱庭ラボコミュニティ</span></div>
    </p>
</div>
...
- [1. 本ドキュメントについて](#1-本ドキュメントについて)
    - [1.1. WSLのインストールの簡易版](#11-wslのインストールの簡易版)
        - [1.1.1. WSLのVersionの確認](#111-wslのversionの確認)
    - [1.2. WSLインストールの詳細](#12-wslインストールの詳細)
        - [1.2.1. BIOSの確認](#121-biosの確認)
        - [1.2.2. Windows OS上の設定](#122-windows-os上の設定)
            - [1.2.2.1. WSL導入用の設定](#1221-wsl導入用の設定)
        - [1.2.3. WSL用のLinuxカーネルのインストール](#123-wsl用のlinuxカーネルのインストール)
            - [1.2.3.1. WSL2を既定設定](#1231-wsl2を既定設定)
                - [1.2.3.1.1. WSLの情報](#12311-wslの情報)
        - [1.2.4. WSLで動作させるディストリビューションのインストール](#124-wslで動作させるディストリビューションのインストール)
            - [1.2.4.1. ディストリビューション導入後のパッケージ追加](#1241-ディストリビューション導入後のパッケージ追加)
