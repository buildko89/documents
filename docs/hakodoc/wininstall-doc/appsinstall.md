...
箱庭ドローンシミュレータに必要な`箱庭アプリ`をインストールするためのインストーラを入手します。以下のリンクをクリックすると`hakoCore-win_vx.x.x.zip`がダウンロードされます。

[箱庭アプリインストーラのzipファイル](https://github.com/buildko89/hakowin/releases/download/v1.0.2/hakoApps-win_v1.0.2.zip)
